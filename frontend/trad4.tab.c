...
#line 299 "trad4.y"
                                             { sprintf (temp, "(>= %s %s)", yyvsp[-2].code, yyvsp[0].code) ;
                                           yyval.code = gen_code (temp) ; }
#line 1854 "trad4.tab.c"
    break;

  case 79: /* termino: operando  */
#line 303 "trad4.y"
                                                   { yyval = yyvsp[0] ; }
#line 1860 "trad4.tab.c"
    break;

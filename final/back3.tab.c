...
#line 176 "back3.y"
                                                  { sprintf (temp, "%s 0=", yyvsp[-1].code) ; 
                                           	    yyval.code = gen_code (temp) ; }
#line 1529 "back3.tab.c"
    break;

  case 46: /* termino: operando  */
#line 182 "back3.y"
                                                      { yyval = yyvsp[0] ; }
#line 1535 "back3.tab.c"
    break;
...
#line 191 "back3.y"
                                         { sprintf (temp, "%d", yyvsp[0].value) ;
                                           yyval.code = gen_code (temp) ; }
#line 1563 "back3.tab.c"
    break;


#line 1567 "back3.tab.c"
